 ...
 * @author kaydr
 */
@WebServlet(urlPatterns = {"/ViewSingleCustomerServlet"})
public class ViewSingleCustomerServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            fnm = request.getParameter("singlecustf");
            lnm = request.getParameter("singlecustl");
            
           Admin s = new Admin();
         
           
           s.singleCustomerSelect(fnm, lnm);
           
           
           HttpSession dentsess;
           dentsess = request.getSession();
           dentsess.setAttribute("s", s);
           System.out.println("Admin added s to daily schedule");
