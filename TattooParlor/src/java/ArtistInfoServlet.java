 ...
 * @author kaydr
 */
@WebServlet(urlPatterns = {"/ArtistInfoServlet"})
public class ArtistInfoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            fn = request.getParameter("afnam");
            ln = request.getParameter("aLnam");
            un = request.getParameter("aunm");
            pw = request.getParameter("apswd");
            ...
            i2.updateArtistDB(id, fn, ln, un, pw);
