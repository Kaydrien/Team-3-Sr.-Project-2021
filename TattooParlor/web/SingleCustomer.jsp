...
<html>
    <head>
        ...
        s = (Admin)session.getAttribute("s");
    ...
    <body>
        ...
        <h1>Customer Appointment Lookup</h1>

        
                <table id="t01">
           <tr>
                <th>Recent Appointments for <%=s.getfname()%> <%=s.getlname()%></th>
	...
	System.out.println("Database connected");
        ...
        ResultSet resultSet = statement.executeQuery ("SELECT FName, LName, ApmntTime, Day from Appointments where Fname = \"" + s.getfname() + "\" AND Lname = \"" + s.getlname() + "\"" );
